...
#|: | Purpose:    Check Websites are alive or not     
#|: |             Date: 10-June-2016        
#| :| 	                                 						  |: | 
#|{>\-------------------------------------------------------------/<}|
#| = : = : = : = : = : = : = : = : = : = : = : = : = : = : = : = : = |
...
$URLListFile = "D:\SeleniumJenkins\RREmersonJobs\Scripts\URLList.txt" 
...
$Outputreport | out-file D:\SeleniumJenkins\RREmersonJobs\Scripts\Test1.htm
Invoke-Expression D:\SeleniumJenkins\RREmersonJobs\Scripts\Test1.htm
